...
const (
	// RunvShimType is the runvShim.
	RunvShimType ShimType = "runvShim"
)
...
func newShimConfig(config PodConfig) interface{} {
	...
	case RunvShimType:
		var runvConfig RunvShimConfig
		err := mapstructure.Decode(config.ShimConfig, &runvConfig)
		if err != nil {
			return err
		}
		return runvConfig
